...
### 🛠️ Технологии:
  ...
  * **Frontend:**
      * [cite\_start]**HTML5:** Структура веб-страницы. [cite: 1]
      * [cite\_start]**CSS3:** Стилизация и адаптивность, включая переменные CSS для легкой смены тем. [cite: 1]
      * [cite\_start]**JavaScript (Vanilla JS):** Динамическое поведение, взаимодействие с API, эффект печати. [cite: 1]
      * [cite\_start]**Marked.js:** Для рендеринга Markdown в HTML. [cite: 1]
      * [cite\_start]**Highlight.js:** Для синтаксической подсветки блоков кода. [cite: 1]
  * **Backend:**
...
4.  **Создайте файл `.env`** в корневой директории проекта и добавьте ваш API-ключ Google Gemini:
    ...
    ```
    (Получить API-ключ можно здесь: [https://makersuite.google.com/](https://makersuite.google.com/))
