...
### 🛠️ Технологии:
  ...
  * **Frontend:**
      * **HTML5:** Структура веб-страницы. [cite: 1]
      * **CSS3:** Стилизация и адаптивность, включая переменные CSS для легкой смены тем. [cite: 1]
      * **JavaScript (Vanilla JS):** Динамическое поведение, взаимодействие с API, эффект печати. [cite: 1]
      * **Marked.js:** Для рендеринга Markdown в HTML. [cite: 1]
      * **Highlight.js:** Для синтаксической подсветки блоков кода. [cite: 1]
  * **Backend:**
